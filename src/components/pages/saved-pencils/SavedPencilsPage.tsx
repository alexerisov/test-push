...
import s from './SavedPencilsPage.module.scss';
...
export const SavedPencilsPage = () => {
  ...
  const content = (
    <div className={s.savedPencils}>
      <h2 className={s.savedPencils__navbar}>
        <Link href="/">
          <a className={s.savedPencils__navbar__link}>Home /</a>
        </Link>
        <span> Saved Chef Pencils</span>
      </h2>

      <h2 className={s.savedPencils__title}>Saved Chef Pencils</h2>
      ...
      <h3 className={s.savedPencils__subtitle}>{`All (${savedPencils?.count ? savedPencils?.count : 0})`}</h3>

      <div className={s.savedPencils__wrapper}>
        <div className={s.savedPencils__container}>
