...
export const TermsPage = () => {
  const content = (
    <div className={s.terms}>
      <h1 className={s.terms__title}>Terms and Conditions of Grocery Delivery E-Services USA INC.</h1>
      <p className={s.terms__text}>
        Welcome and thank you for visiting EatChefs.com (“Site”) or our mobile applications (“App”) and our Terms and
        Conditions (“Terms”).
      </p>
      <p className={s.terms__textBold}>
      ...
      <p className={`${s.terms__text} ${s.terms__marginBottom}`}>
        You should print a copy of these terms and conditions for future reference.
      </p>

      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>1. INFORMATION ABOUT US</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>2. SERVICE AVAILABILITY AND YOUR STATUS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>3. MODIFICATION</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>4. REGISTRATION</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>5. EatChefs'S SERVICES</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>6. PAYMENT AND PRICING</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>7. REPLACEMENT INGREDIENTS IN MEAL KITS AND PROMOTIONAL INCLUSIONS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>8. GIFT CARDS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>9. VOUCHERS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>10. DELIVERY</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>11. FORCE MAJEURE</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>12. RECEIPT OF THE MATERIALS AND FOOD PREPARATION</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>13. RECIPE CARDS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>14. RETURN AND REFUND POLICY</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>15. PROPRIETARY RIGHTS</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>16. PROHIBITED USES</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>17. NON-USER THIRD PARTY CONTENT</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>18. USER CONDUCT</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>19. USER CONTENT</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>20. INDEMNIFICATION</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>21. DISCLAIMERS</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>22. LIMITATION OF LIABILITY</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>23. MODIFICATIONS TO THE SITE AND PRODUCTS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>24. DISPUTE RESOLUTION & BINDING ARBITRATION</h2>
        <div>
          <p className={s.terms__text}>
          ...
          <p className={`${s.terms__text} ${s.terms__text_wordWrap}`}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>25. GOVERNING LAW AND VENUE</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>26. TERM, TERMINATION AND SURVIVAL</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>27. SEVERABILITY AND WAIVER</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>28. APP STORES</h2>
        <div>
          <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>29. MISCELLANEOUS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>30. CONSUMER COMPLAINTS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>31. ELECTRONIC COMMUNICATIONS</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>32. EXPORT CONTROL</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>33. NOTICE</h2>
        <p className={s.terms__text}>
      ...
      <div className={s.terms__textBlock}>
        <h2 className={s.terms__subtitle}>34. SWEEPSTAKES</h2>
        <p className={s.terms__text}>
