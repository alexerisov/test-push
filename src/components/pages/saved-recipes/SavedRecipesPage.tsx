...
import s from './SavedRecipesPage.module.scss';
...
export const SavedRecipesPage = () => {
  ...
  const content = (
    <div className={s.savedRecipes}>
      <h2 className={s.savedRecipes__navbar}>
        <Link href="/">
          <a className={s.savedRecipes__navbar__link}>Home /</a>
        </Link>
        <span> Saved Recipes</span>
      </h2>

      <h2 className={s.savedRecipes__title}>Saved Recipes</h2>
      ...
      <h3 className={s.savedRecipes__subtitle}>{`All (${savedRecipes?.count ? savedRecipes?.count : 0})`}</h3>

      <div className={s.savedRecipes__wrapper}>
        <div className={s.savedRecipes__container}>
